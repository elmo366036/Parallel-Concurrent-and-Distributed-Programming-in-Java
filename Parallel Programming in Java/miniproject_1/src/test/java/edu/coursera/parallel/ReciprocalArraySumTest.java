...
public class ReciprocalArraySumTest extends TestCase {
    ...
    public void testParManyTaskTwoMillion() {
        final int ncores = getNCores() / 2; //added /2 to remove hyper threads from core count
        // in the original code ncores = getNCores() it reports 8 cores when there are only 4 with 2 hyperthreads
